...
const origins = [
  {
    ...
    process: 'Natural / 日晒处理',
    flavor: '蓝莓 · 茉莉 · 深可可',
    description:
      '在衣索比亚高原，古老的咖啡树沐浴在热带阳光与迷雾之中。每一批豆子都是大地的礼物，散发着令人窒息的花香。',
  ...
  },
  {
    ...
    flavor: '红糖 · 焦糖苹果 · 杏仁',
    description:
      '哥伦比亚安地斯山脉的农庄以家族方式耕作数十年，每一粒咖啡豆都承载着三代人的骄傲与汗水。',
    img: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?q=80&w=1600&auto=format&fit=crop',
    accent: '#D4A373',
  },
  {
    region: 'Indonesia',
    subtitle: 'Sumatra · 苏门答腊',
    altitude: '1,200 – 1,600m',
    process: 'Wet Hulled / 湿刨处理',
    flavor: '草药 · 可可 · 柔顺甜感',
    description:
      '在印度尼西亚苏门答腊高地，古老的湿刨工艺赋予咖啡独特的泥土韵味。这是东南亚最神秘的咖啡产地，每一杯都承载着雨林的秘密。',
    img: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?q=80&w=1600&auto=format&fit=crop',
    accent: '#B8936A',
  },
];
